...
curl -f http://localhost:8003/billing-service.yaml -o /app/billing-service.yaml || echo "Swagger fetch failed"
cp /app/billing-service.yaml /api-specs/ || echo "Copy to api-specs failed"
